 ...
 */
@file:UseSerializers(LocalDateSerializer::class, UUIDSerializer::class, TimestampSerializer::class)
...
suspend fun FirebaseDataConnect.requestTimeAsTimestamp(): Timestamp =
  requestTime().requestTimeAsTimestamp
...
private data class ExprValuesQueryData(val item: Item?) {
  ...
  data class Item(
    ...
    val requestTimeAsTimestamp: Timestamp,
  )
}
...
@Serializable private data class ExprValuesKey(val id: UUID)
